...
\item {\textbf{Personalizado:} Que el sistema reconozca a cada usuario y sugiera contenido al usuario en base a solicitudes previas por parte de este.
Adem\'as, debe permitir un sistema de pr\'estamo de contenidos.}
\item {\textbf{Transparente:} Los contenidos pueden continuarse viendo en otros dispositivos que lo soporten desde el \'ultimo estado en que se dejaron.}
\item {\textbf{Calidad de contenidos:} Que las aplicaciones hayan pasado satisfactoriamente tests de calidad los cuales definen los requisitos funcionales que \'estas deben cumplir.} 
\end{itemize}
\newpage
...
\subsection{Diagrama de Contexto}
	...
	\begin{center}
		\includegraphics[scale=0.37]{Diagramas/DiagramaContexto.png}
	\end{center}
...
\subsection{Aclaraciones previas}
	...
	En los gr\'aficos tambi\'en existen, a modo de ayuda, una serie de rect\'angulos explicativos que aclaran ciertos conceptos en el contexto donde aparecen.
